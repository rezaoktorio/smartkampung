...
<html>
    ...
    <?php
        ...
        // mysqli_connect("mysql.hostinger.co.id", "u573987905_admin", "eoWFjOYK0SdwBd", "u573987905_smart");
    ?>
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="http://www.smartkampung.com/smartkampung_backend/view/dashboard/" class="logo"><i class="md md-album icon-c-logo"></i><span>Smart<i class="md md-album"></i>Kampung</span></a>
                        <!-- Image Logo here -->
                    ...
                    <div class="container">
                        <div class="">
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="hidden-xs">
                                    <a href="http://www.smartkampung.com/smartkampung_backend/" target="_" class="right-bar-toggle waves-effect waves-light"><i class="ti-layout"></i></a>
                                </li>
                                <li class="hidden-xs">
                                    <a href="http://www.smartkampung.com/smartkampung_backend/view/dashboard/" target="_" class="right-bar-toggle waves-effect waves-light"><i class="ti-home"></i></a>
                                </li>
                            </ul>
                        </div>
                        <!--/.nav-collapse -->
                        ...
                        <form name="cari" action="detil.php" method="post">
                            <div class="col-sm-12 clearfix">
                                <select class="selectpicker" name="kampung" data-live-search="true" data-style="btn-white" tabindex="-98">
                                    <?php
                                      $query = mysqli_query($koneksi, "SELECT DISTINCT(kampung.namakampung) AS nama, rekapitulasi.idkampung AS id FROM rekapitulasi JOIN kampung ON rekapitulasi.idkampung = kampung.idkampung");
                                      $no = 1;
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <?php require_once('../../model/visualisasi/fill.php'); ?>
