            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="http://www.smartkampung.com/smartkampung_backend/view/visualisasi/" class="logo"><i class="md md-album icon-c-logo"></i><span>Smart<i class="md md-album"></i>Kampung</span></a>
                        <!-- Image Logo here -->
                    ...
                    <div class="container">
                        <div class="">
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="hidden-xs">
                                    <a href="http://www.smartkampung.com/smartkampung/" target="_" class="right-bar-toggle waves-effect waves-light"><i class="ti-layout"></i></a>
                                </li>
                                <li class="hidden-xs">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <?php require_once('../../model/visualisasi_detil/fill.php'); ?>
