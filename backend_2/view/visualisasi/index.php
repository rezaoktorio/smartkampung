            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="http://smartcity.webplussolution.com/smartcity_backend/view/dashboard/" class="logo"><i class="md md-album icon-c-logo"></i><span>Smart<i class="md md-album"></i>Kampung</span></a>
                        <!-- Image Logo here -->
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <?php include('../../model/visualisasi/fill.php'); ?>
